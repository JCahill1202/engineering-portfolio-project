export const skillGroups = [
  {
    ...
    items: ["SolidWorks", "FreeCAD", "3D Printing", "PCB Design", "Soldering"],
  },
  {
    title: "Programming",
    items: ["Python", "C++", "Arduino", "LaTeX"],
  },
  {
    title: "Circuits & Testing",
    items: ["Circuit Design / Testing", "Oscilloscopes", "Bench PSUs / multimeters"],
  },
];

export const experience = [
  {
    role: "Physics Lab Instructor",
  ...
  {
    role: "Optical Engineer Summer Intern",
